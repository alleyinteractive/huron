...
var _mergeWith = __webpack_require__(26);
...
function configureEntries(huron, config) {
  ...
  if (!_parseArgs2.default.production) {
    newConfig.entry[huron.hotEntry] = [`webpack-dev-server/client/index.js?http://localhost:${huron.port}/`, 'webpack/hot/dev-server', _path2.default.join(cwd, huron.root, 'huron-assets/index')].concat(entry);
  } else {
    newConfig.entry[huron.hotEntry] = [_path2.default.join(cwd, huron.root, 'huron-assets/index')].concat(entry);
  }
...
var _webpackDevServer = __webpack_require__(30);
...
var _opn = __webpack_require__(28);
