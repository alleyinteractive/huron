...
/***/ "./node_modules/raw-loader/index.js!./node_modules/babel-loader/lib/index.js!./templates/hotTemplate.js":
/*!********************************************************************************************!*\
  !*** ./node_modules/raw-loader!./node_modules/babel-loader/lib!./templates/hotTemplate.js ***!
  \********************************************************************************************/
/*! no static exports found */
...
var _handleHTML = __webpack_require__(/*! ./handleHTML */ "./src/cli/handleHTML.js");

var _handleTemplates = __webpack_require__(/*! ./handleTemplates */ "./src/cli/handleTemplates.js");

var _handleKSS = __webpack_require__(/*! ./handleKSS */ "./src/cli/handleKSS.js");
...
function updateFile(filepath, store) {
  ...
  switch (file.ext) {
    ...
    case '.json':
      ...
      console.log(_chalk2.default.red(`Failed to find KSS section for ${filepath}`));
...
function deleteFile(filepath, store) {
  ...
  switch (file.ext) {
    ...
    default:
      console.warn(_chalk2.default.red(`Could not delete: ${file.name}`));
      break;
  }
...
var _generateConfig = __webpack_require__(/*! ./generateConfig */ "./src/cli/generateConfig.js");
...
const defaultStore = (0, _immutable.Map)({
  ...
  classNames: (0, _utils.getClassnamesFromJSON)(config.huron.classNames),
...
var _gaze = __webpack_require__(/*! gaze */ "gaze");
...
var _defaultStore = __webpack_require__(/*! ./defaultStore */ "./src/cli/defaultStore.js");
...
if (huron.get('classNames')) {
  ...
  _path2.default.resolve(huron.get('classNames')));
}
...
var _parseArgs = __webpack_require__(/*! ./parseArgs */ "./src/cli/parseArgs.js");

var _parseArgs2 = _interopRequireDefault(_parseArgs);

var _requireExternal = __webpack_require__(/*! ./requireExternal */ "./src/cli/requireExternal.js");

var _requireExternal2 = _interopRequireDefault(_requireExternal);

var _webpack3 = __webpack_require__(/*! ../defaultConfig/webpack.config */ "./src/defaultConfig/webpack.config.js");

var _webpack4 = _interopRequireDefault(_webpack3);

var _huron = __webpack_require__(/*! ../defaultConfig/huron.config */ "./src/defaultConfig/huron.config.js");
...
function configureEntries({ entry, root, port }, config) {
  ...
  const devServerEntries = _parseArgs2.default.production ? [] : [`webpack-dev-server/client/index.js?http://localhost:${port}/`, 'webpack/hot/dev-server'];

  return Object.assign({}, config, {
    entry: {
      [entry]: Array.prototype.concat(devServerEntries, _path2.default.join(cwd, root, 'huron-assets/index'), originalEntry)
    }
  });
}
...
var _kss = __webpack_require__(/*! kss */ "kss");
...
var _requireTemplates = __webpack_require__(/*! ./requireTemplates */ "./src/cli/requireTemplates.js");
...
var _fileWatcher = __webpack_require__(/*! ./fileWatcher */ "./src/cli/fileWatcher.js");
...
var _hotTemplate = __webpack_require__(/*! raw-loader!babel-loader!../../templates/hotTemplate */ "./node_modules/raw-loader/index.js!./node_modules/babel-loader/lib/index.js!./templates/hotTemplate.js");
...
var _devServer = __webpack_require__(/*! ../../config/devServer.config */ "./config/devServer.config.js");
  ...
  if (_parseArgs2.default.production) {
    compiler.run((err, stats) => {
      ...
      if (stats.hasWarnings()) {
        console.error(_chalk2.default.yellow('Webpack encountered warnings during compile: ', info.warnings)); // eslint-disable-line max-len
      }
    });
  } else {
...
exports.getClassnamesFromJSON = getClassnamesFromJSON;
...
function writeSectionData(store, section, sectionPath = false) {
  ...
  console.warn(_chalk2.default.red(`Failed to write data for ${section.referenceURI}`));
  return false;
}
...
function removeFile(id, type, filepath, store) {
  ...
  if (kssDir) {
    ...
    try {
      ...
      console.log(_chalk2.default.red(`${outputRelative} does not exist or cannot be deleted`)); // eslint-disable-line
    }
...
function getClassnamesFromJSON(filepath) {
  const fileInfo = _path2.default.parse(filepath);
  let classNames = {};

  if ('.json' === fileInfo.ext) {
    try {
      const contents = _fsExtra2.default.readFileSync(filepath, 'utf8');
...
var _parseArgs = __webpack_require__(/*! ../cli/parseArgs */ "./src/cli/parseArgs.js");

var _parseArgs2 = _interopRequireDefault(_parseArgs);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = ({ root, output }) => ({
  mode: 'development',
  entry: {},
  output: {
    path: _path2.default.join(process.cwd(), root),
    publicPath: _parseArgs2.default.production ? '' : `/${root}`,
    filename: '[name].js',
  ...
  module: {
    rules: [{
      test: /\.html$/,
      include: [_path2.default.join(process.cwd(), root, output)],
      use: 'html-loader'
    }, {
      test: /\.(hbs|handlebars)$/,
      include: [_path2.default.join(process.cwd(), root, 'huron-assets')],
      use: {
...
module.exports = __webpack_require__(/*! ./src/cli/index */"./src/cli/index.js");
