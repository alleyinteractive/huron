...
/******/ 	var hotCurrentHash = "b385840738227bb371de"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var js = [];
	if (true) {
	  module.hot.accept([3, 2], function (update) {
	    var updatedModules = Object.keys(update);
	    if (updatedModules.length) {
	      var template = __webpack_require__(update[updatedModules[0]][0]);
	      templateReplaceCallback(template);
	    }
	  });
	}
	templates['test-partial-one'] = __webpack_require__(3);
	templates['test-partial-two'] = __webpack_require__(2);
	css.push(__webpack_require__(4));
	if (true) {
	  module.hot.accept();
	}
	...
	var InsertNodes = function () {
	  function InsertNodes(context, templates) {
	  ...
	  _createClass(InsertNodes, [{
	    ...
	    key: 'replaceEl',
	    value: function replaceEl(template) {
	      var templateWrapper = template.querySelector('template');
	      var templateId = templateWrapper.getAttribute('id');
	      var tags = this.context.querySelectorAll(templateId);
	    ...
	    key: 'checkNestedTemplates',
	    value: function checkNestedTemplates(parentId, templateWrapper) {
	      for (var templateId in this.templates) {
	        var subTemplateMarker = templateWrapper.content.querySelector(templateId);

	        if (null !== subTemplateMarker && 0 === subTemplateMarker.children.length) {
	          var subTemplate = this.templates[templateId];
	    ...
	    key: 'hasTemplate',
	    value: function hasTemplate(templateId, template) {
	      var subTemplate = template.querySelector('template').content.querySelector(templateId);
...
/***/ function(module, exports) {
	...
	module.exports = "<template id=\"test-partial-two\"><div class=\"test-partial-two\">\n\t<span>Hello again, world!</span>\n</div></template>";
...
/***/ function(module, exports) {
	...
	module.exports = "<template id=\"test-partial-one\">\n\t<div class=\"test-partial-one\">\n\t\t<span>Hello, world!</span>\n\t\t<test-partial-two></test-partial-two>\n\t</div>\n</template>";
	var elm = document.createElement("div");
	elm.innerHTML = module.exports;
	module.exports = elm;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".test-partial-one {\n\tcolor: blue;\n}\n\n.test-partial-two {\n\tcolor: red;\n}", ""]);
