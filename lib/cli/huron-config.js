...
function processArgs() {
  ...
  }).option('-r, --root [root]', '[root] directory for the server, defaults to current working directory', _huron.cwd).option('--port [port]', '[port] to listen the server on', function (port) {
