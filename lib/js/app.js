    ...
    value: function importTemplates() {
      ...
      if (!this.hasBundle) {
        ...
        for (var i = 0; i < this.bundles.length; i++) {
          var bundle = this.bundles.item(i);
          ...
          for (var _i = 0; _i < bundleTemplates.length; _i++) {
            var template = bundleTemplates.item(_i);
            var templateID = template.getAttribute('id');
      ...
      for (var templateID in this.templates) {
        ...
        for (var i = 0; i < tags.length; i++) {
          ...
          if (tag.childNodes.length) {
            for (var _i2 = 0; _i2 < tag.childNodes.length; _i2++) {
              var childEl = tag.childNodes.item(_i2);
